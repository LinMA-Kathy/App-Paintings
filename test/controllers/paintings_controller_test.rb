...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference("Painting.count") do
      post paintings_url, params: { painting: { description: @painting.description, image_url: @painting.image_url, title: @painting.title, year: @painting.year } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { description: @painting.description, image_url: @painting.image_url, title: @painting.title, year: @painting.year } }
